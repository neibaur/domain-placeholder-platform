...
| Domain      | `PUBLIC_SITE_URL`   | `PUBLIC_SITE_NAME`   | `PUBLIC_ROBOTS_INDEX` |
| ----------- | ------------------- | -------------------- | --------------------- |
| `68tai.com` | `https://68tai.com` | `Domain Placeholder` | `false`               |
| `6gou8.com` | `https://6gou8.com` | `Domain Placeholder` | `false`               |
| `6xi8.com`  | `https://6xi8.com`  | `Domain Placeholder` | `false`               |
